# Contributing to LlamaDb3

Thank you for your interest in contributing to LlamaDb3! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaDb3:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamadb3.git
   cd llamadb3
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamadb3.git
   ```
...
By contributing to LlamaDb3, you agree that your contributions will be licensed under the project's MIT License.
